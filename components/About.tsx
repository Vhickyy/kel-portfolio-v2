  ...
  return (
    <section className='pt-[8rem]'>
      <div className='flex items-center justify-center'>
        ...
        <h2 className='font-extrabold text-3xl text-textColor'>About <span className="text-primary">Me</span></h2>
        {/* <div className='w-[7rem] h-[1px] bg-textgray'></div> */}
      </div>
      <div>
        <p className='text-textgray leading-loose mt-6   tracking-wider'>
        I am a Business Management graduate, a Business Assistant and a <span className="text-primary font-bold">Canva Expert</span> with more than 3years experience. I am also a <span className="text-primary font-bold">Canvassador</span>.
        {/* </p> */}
        {/* <p className='text-textgray leading-loose mt-6   tracking-wider'> */}
        I take my client's work very seriously and always deliver on time.
